  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16">
        <div className="rounded-3xl border border-gold/30 bg-black/35 p-6 backdrop-blur-xl md:p-8">
          <div className="flex flex-col items-center gap-8 md:flex-row md:items-center">
            <motion.img
              src={hairwash}
              alt="Relaxing hair wash at SK Pro Beauty Hub"
              className="mx-auto h-72 w-full max-w-md rounded-3xl object-cover shadow-xl md:h-[22rem] md:max-w-lg"
